...
if [[ -z "$logcheck" ]] && [[ "$logcheck" != "Y" ]] && [[ "$logcheck" != "n" ]];  then
        ...
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < logs.sql
        echo "Done."
        ...
        if [[ -z "$logdb" ]]; then
                ...
                echo "Inserting logs.sql.."
                mysql -u "$username" -h"$hostname" -p"$password" "$logdb" < logs.sql
                echo "Done."
...
if [[ "$base" == "re" ]]; then
        ...
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < mob_db.sql
        echo "Done inserting mob_db.sql."
        echo ""
        echo "Inserting mob_db2.sql..."
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < mob_db2.sql
        echo "Done inserting mob_db2.sql."
        echo ""
        echo "Inserting mob_skill_db.sql..."
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < mob_skill_db.sql
        echo "Done inserting mob_skill_db.sql."
        echo ""
        echo "Inserting mob_skill_db2.sql..."
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < mob_skill_db2.sql
        ...
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < mob_skill_db_re.sql
        echo "Done inserting mob_skill_db_re.sql..."
        echo ""
        echo "Inserting item_cash_db.sql..."
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < item_cash_db.sql
        echo "Done inserting item_cash_db.sql."
        echo ""
        echo "Inserting item_cash_db2.sql..."
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < item_cash_db2.sql
        ...
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < mob_db2_re.sql
        ...
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < mob_skill_db2_re.sql
        echo "Done inserting mob_skill_db2_re.sql."
        echo ""
        echo "Inserting roulette_default_data.sql..."
        mysql -u "$username" -h"$hostname" -p"$password" "$database" < roulette_default_data.sql
